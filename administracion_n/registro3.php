...
$asunto="ALTA DE SERVICIO EN CHECKPOOL";
$href="https://control.nativecbc.com/administracion_n/activacion3.php?".$codvalidarinc;
    ...
    $subject = $asunto;
		...
		$message = "
				...
				<body><center>
				<table>
				<tr><td colspan='3' align='center'><img src='https://control.nativecbc.com/img/checkpool_logo.png'></td></tr>
				<tr><td colspan='3' >Bienvenidos al Portal de CheckPool</td></tr>
				<tr><td colspan='3' >Hola $nombremp2 :</td></tr>
				<tr><td colspan='3' >Bienvenidos al Portal de CheckPool, a continuaci&oacute;n le indicamos los datos de acceso</td></tr>
...
distribuci&oacute;n, impresi&oacute;n o copia de toda o alguna parte de la informaci&oacute;n contenida.
    ...
    $headers = 'From: CHECKPOOL - CONTROL INTELIGENTE DE PISCINAS - <info@checkpool.es>' . $eol;
if ($emailadmin2!=""){;   
    $headers .= 'Cc: '.$emailadmin2  . $eol;
};

	 $headers .= 'Bcc: checkpool@yahoo.com'  . $eol;
