...
<body class='html' style='background-image:url(../img/iconos/checkmant-fondo.jpg);
...
<div class='hijo' style='background-color:#f5f5f5'>
  ...
  <div class='imgcontainer'>
    <img src='../img/iconos/p-7-log.png' width="250px">
...
$asunto="ALTA DE SERVICIO EN CHECKMANT";
$href="https://control.nativecbc.com/administracion_n/activacion7.php?".$codvalidarinc;
    ...
    $subject = $asunto;
		...
		$message = "
				...
				<body><center>
				<table>
				<tr><td colspan='3' align='center'><img src='https://control.nativecbc.com/img/iconos/p-7-log.png' width='250px'></td></tr>
				<tr><td colspan='3' >Bienvenidos al Portal de CHECKMANT</td></tr>
				<tr><td colspan='3' >Hola $nombremp2 :</td></tr>
				<tr><td colspan='3' >Bienvenidos al Portal de CHECKMANT, a continuaci&oacute;n le indicamos los datos de acceso</td></tr>
...
distribuci&oacute;n, impresi&oacute;n o copia de toda o alguna parte de la informaci&oacute;n contenida.
    ...
    $headers = 'From: CHECKMANT - CONTROL INTELIGENTE DE SU PERSONAL - <info@checkmant.com>' . $eol;
if ($emailadmin2!=""){;   
    $headers .= 'Cc: '.$emailadmin2  . $eol;
};

	 $headers .= 'Bcc: checkmant@yahoo.com'  . $eol;
