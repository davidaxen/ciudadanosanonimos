...
$asunto="ALTA DE SERVICIO EN CHECKPORTER";
$href="https://control.nativecbc.com/administracion_n/activacion8.php?".$codvalidarinc;
    ...
    $subject = $asunto;
		...
		$message = "
				...
				<body><center>
				<table>
				<tr><td colspan='3' align='center'><img src='https://control.nativecbc.com/img/iconos/p-8-log.png' width='250px'></td></tr>
				<tr><td colspan='3' >Bienvenidos al Portal de CHECKPORTER</td></tr>
				<tr><td colspan='3' >Hola $nombremp2 :</td></tr>
				<tr><td colspan='3' >Bienvenidos al Portal de CHECKPORTER, a continuaci&oacute;n le indicamos los datos de acceso</td></tr>
...
distribuci&oacute;n, impresi&oacute;n o copia de toda o alguna parte de la informaci&oacute;n contenida.
    ...
    $headers = 'From: CHECKPORTER - CONTROL INTELIGENTE DE SU PERSONAL - <info@checkporter.com>' . $eol;
if ($emailadmin2!=""){;   
    $headers .= 'Cc: '.$emailadmin2  . $eol;
};

	 $headers .= 'Bcc: checkporter@yahoo.com'  . $eol;
