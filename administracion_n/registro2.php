...
<div class='hijo' style='background-color:#f5f5f5'>
  ...
  <div class='imgcontainer'>
    <img src='../img/iconos/p-2-log.jpg' width='250px'>
...
$asunto="ALTA DE SERVICIO EN APPMIFINCA";
$href="https://control.nativecbc.com/administracion_n/activacion2.php?".$codvalidarinc;
    ...
    $subject = $asunto;
		...
		$message = "
				...
				<body><center>
				<table>
				<tr><td colspan='3' align='center'><img src='https://control.nativecbc.com/img/iconos/p-2-log.jpg' width='250px'></td></tr>
				<tr><td colspan='3' >Bienvenidos al Portal de APPMIFINCA</td></tr>
				<tr><td colspan='3' >Hola $nombremp2 :</td></tr>
				<tr><td colspan='3' >Bienvenidos al Portal de APPMIFINCA, a continuaci&oacute;n le indicamos los datos de acceso</td></tr>
...
distribuci&oacute;n, impresi&oacute;n o copia de toda o alguna parte de la informaci&oacute;n contenida.
    ...
    $headers = 'From: APPMIFINCA - CONTROL INTELIGENTE DE SU PERSONAL - <info@appmifinca.com>' . $eol;
if ($emailadmin2!=""){;   
    $headers .= 'Cc: '.$emailadmin2  . $eol;
};

	 $headers .= 'Bcc: appmifinca@yahoo.com'  . $eol;
