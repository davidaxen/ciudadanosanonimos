<?php
	...
	if ($resultadousuario['tusuario'] == 61) {
		$gestor = 1;
	}else{
		$gestor = 0;
	}
	...
	$fecha = date("g:i A");
	$sql1 = "INSERT INTO chatpais (idusuario, idpais, msg, timehour, chat, tuser) VALUES (".$resultadousuario['id'].",".$resultado['pais'].",'".stripslashes(htmlspecialchars($text))."','".$fecha."', 1, $gestor)";
	$conn->exec($sql1);
