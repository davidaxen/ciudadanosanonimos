...
<img src="img/<?php  echo $imgpr;?>" width="100px">
<div class="cartel" >
<?php  include('menu_n/cartel.php');?>
<?php if ($dispositivo=='movil'){;?>
...
<div class="pie"></div>
<!--
<div class="logo"><?php /* include('utilidades_n/logo_nuevo.php');*/?></div> 
<div class="menu"><?php /* include('menu_n/menup.php');*/?></div>
-->
